...
function sortUserByAgeDesc(arr) {
  arr.sort((a, b) => {
    return b.age - a.age;
  });
  return arr;
}
console.log(sortUserByAgeDesc(listUser));

//Dùng phương thức sort() để sắp xếp
//mảng giảm dần và a và b là phần tử trong trong mảng listUser
